              ...
              Flexible(
                child: ListView(
                  ...
                  children: [
                    ...
                    StreamBuilder<List<CabinetRecord>>(
                      stream: queryCabinetRecord(
                        limit: 20,
                      ),
                      builder: (context, snapshot) {
                        ...
                        List<CabinetRecord> listViewCabinetRecordList =
                            snapshot.data!;
                        ...
                        return ListView.separated(
                          ...
                          shrinkWrap: true,
                          scrollDirection: Axis.vertical,
                          itemCount: listViewCabinetRecordList.length,
                          separatorBuilder: (_, __) => SizedBox(height: 14.0),
                          itemBuilder: (context, listViewIndex) {
                            final listViewCabinetRecord =
                                listViewCabinetRecordList[listViewIndex];
                            return Container(
                              width: double.infinity,
                              decoration: BoxDecoration(
                                color: FlutterFlowTheme.of(context)
